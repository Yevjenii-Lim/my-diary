          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="mailto:yevhenii.lim27@gmail.com" className="hover:text-white transition-colors">Features</a></li>
                <li><a href="mailto:yevhenii.lim27@gmail.com" className="hover:text-white transition-colors">Pricing</a></li>
                <li><a href="mailto:yevhenii.lim27@gmail.com" className="hover:text-white transition-colors">Security</a></li>
              </ul>
            </div>
            <div>
